...
public class StructuredTaskAccessProviderJPA implements
    ...
    private static StructuredTaskAccessProviderJPA sdapInstance;
    ...
    protected StructuredTaskAccessProviderJPA() {
    ...
    public static StructuredTaskAccessProviderJPA newInstance() {

        if (sdapInstance == null) {
            sdapInstance = new StructuredTaskAccessProviderJPA();
        }
