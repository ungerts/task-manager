...
public class StructuredWorkItemView {
    ...
    public StructuredWorkItemView(WorkItemView workItem,
                                  TaskStructure structureData)
            throws HumanTaskManagerException {

        for (TaskStructure controlledTask : structureData.getSelectedTaskControlledTasks()) {
    ...
    public WorkItemView getWorkItem() {
        return workItem;
    }
